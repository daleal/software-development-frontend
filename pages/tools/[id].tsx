                ...
                <div className="lg:col-start-1 lg:col-span-2">
                  <div className="flex justify-between">
                    ...
                    <div className="lg:col-start-3 lg:col-span-2 mt-16">
                      ...
                      <h2 className="font-bold text-yellow-400 xl">
                        {" "}
                        $ {toolListing.price}{" "}
                      </h2>
                      <p className="text-sm text-gray-500">
                        {" "}
                        Para arrendar esta herramienta por favor contáctate
                        directamente con el arrendador.{" "}
                      </p>
                      <p className="text-sm text-gray-500">
                        {" "}
                        Número de contacto: {toolListing.phoneNumber}{" "}
                      </p>
                    </div>
                  </div>
                  {isPublisher ? (
